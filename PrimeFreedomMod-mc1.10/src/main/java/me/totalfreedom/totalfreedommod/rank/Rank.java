...
public enum Rank implements Displayable
{
    ...
    EXECUTIVE("an", "Executive", Type.ADMIN, "Exec", ChatColor.GOLD),
    SYSTEM_ADMIN("a", "System Admin", Type.ADMIN, "SYS", ChatColor.DARK_RED),
    FOUNDER("a", "Founder", Type.ADMIN, "Founder", ChatColor.DARK_RED),
