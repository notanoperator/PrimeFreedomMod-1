...
public class RankManager extends FreedomService
{
    ...
    public Displayable getDisplay(CommandSender sender)
    {
        ...
        if (FUtil.PFMDEVELOPERS.contains(player.getName()))
        {
            return Title.PFMDEVELOPER;
        }
        if (FUtil.PFMLEADDEVELOPERS.contains(player.getName()))
        {
            return Title.PFMLEADDEVELOPER;
        }
